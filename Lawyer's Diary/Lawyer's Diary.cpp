...
class trie {
	...
	int cl = 0;
public:
	void insertnode(trienode* root, string name, string last_date, string next_date, string roomno,string courtname);
	void insertdetails(string name, string last_date, string next_date, string roomno,string courtname)
	{
		insertnode(root, name, last_date, next_date, roomno,courtname);
	}
...
int main()
{
	...
	do {
		...
		if (choice == 1)
		{
			system("cls");
			logo2();
			string name, ldate, ndate, room,cname;
			cout << " Enter Name: ";
			getline(cin, name);
			cout << " Enter last hearing: ";
			getline(cin,ldate );
			cout << " Enter next hearing: ";
			getline(cin,ndate );
			cout << " Enter Room no: ";
			getline(cin,room);
			cout << " Enter Court Name: ";
			getline(cin,cname );
			root.insertdetails(name, ldate, ndate, room,cname);
...
void trie::insertnode(trienode* root, string name, string last_date, string next_date, string roomno, string courtname)
{
...
void trie::displaynode(trienode* root, string name)
{
	...
	if (temp->eow == true)
	{
		...
		cout << " Last hearing was on -> "<<temp->last_date;
		cout << "\n Next hearing is on -> "<<temp->next_date;
		cout << "\n Court -> "<<temp->courtname;
		cout << "\n Room no. -> " << temp->roomno;
	}
	else
		cout << "\n ************ NO SUCH CLIENT EXISTS IN DIARY ************** ";
